...
Accounting for the presence of delays, Equation~\eqref{eq:master-eqn} can be written as: \todo{check for correctness}
\begin{multline}
...
\todo{Undersampling of state space: Why/when does it happen? Why do we want to avoid it? Examples?}
