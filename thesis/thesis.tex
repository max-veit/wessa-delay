...
\todo{Many different ways of dealing with this problem - mention a few used besides the WE?}
\todo{Why WE used? Statistically exact, straightforward implementation, generality, applicability to high-dimensional spaces}
...
\todo{describe qualitative behavior of cond'l average (unimodal to bimodal)}

\todo{better introduce prediction for cond'l average near bifurcation}
