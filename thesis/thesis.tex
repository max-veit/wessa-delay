...
The propensity functions have different forms depending on the order of the reaction, i.e. whether it is a production (zero-order), unimolecular, bimolecular, or higher-order reaction.
